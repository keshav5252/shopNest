...
import { Dialog, DialogPanel, PopoverGroup, Input } from "@headlessui/react";
...
export default function Header() {
  ...
  return (
    <header className="bg-white m-auto ">
      <nav
        aria-label="Global"
      ...
      >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12 lg:items-center">
          <Input
            ...
            className="w-[40vw] p-2 bg-[whitesmoke] rounded-md border outline-none"
          />
          <Link
            to="#"
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6 flex flex-col gap-2">
                <Input
                  ...
                  type="text"
                  placeholder="Search for Products, Brand and more..."
                  className="w-[90vw] p-2 bg-[whitesmoke] rounded-md border outline-none"
                />
                <Link
                  to="#"
                  className="text-sm/6 font-semibold text-gray-900 flex items-center gap-1"
